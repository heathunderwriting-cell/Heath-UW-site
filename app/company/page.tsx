      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <section style={{ padding: '100px 48px 80px', maxWidth: 1100, margin: '0 auto', borderBottom: `1px solid ${BLUE_BORDER}` }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.4rem,5vw,3.8rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: 24 }}>
            Built for the complexity<br />of <span style={{ color: BLUE }}>institutional risk</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: MUTED, maxWidth: 680, lineHeight: 1.7 }}>
            Heath is an <strong style={{ color: WHITE }}>AI-native Managing General Agent</strong> combining disciplined underwriting, intelligent AI workflows, and long-term capacity partnerships to deliver results where conventional solutions fall short.
          </p>
        </section>
