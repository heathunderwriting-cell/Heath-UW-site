    ...
    <main className="relative min-h-screen text-[#f0f4ff]">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 pb-16 pt-28">
        ...
        <div className="mb-8 text-center">
          ...
          <div className="mt-2 text-[10px] font-bold uppercase tracking-[0.32em] text-white/30">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-2 text-[13px] font-medium text-white/40 transition-colors hover:text-cyan-300"
        >
