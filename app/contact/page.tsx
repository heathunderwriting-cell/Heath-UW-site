...
export default function ContactPage() {
  ...
  const inputCls =
    "w-full rounded-lg border border-border bg-background/60 px-3.5 py-2.5 text-sm text-primary placeholder:text-secondary/70 outline-none transition focus:border-[#4a9eff] focus:ring-2 focus:ring-[#4a9eff]/30";
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_1.1fr]">
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                className="group rounded-2xl border border-border bg-card/50 p-5 backdrop-blur-sm transition hover:border-[#4a9eff]/60"
              >
              ...
              <Link
                href="/underwriting"
                className="mt-1 inline-flex items-center justify-center self-start rounded-full border border-border bg-background/50 px-6 py-2.5 text-sm font-semibold text-primary transition-colors hover:bg-muted/40"
              >
                {copy.secondary}
              </Link>
            </div>
            ...
            <form
              ...
              className="rounded-2xl border border-border bg-card/60 p-6 shadow-soft backdrop-blur-sm md:p-7"
            >
