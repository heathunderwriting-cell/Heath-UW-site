...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-white/[0.07] bg-[#081226]/40 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-6 py-12 md:px-10 md:py-14">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/40">{dict.footer.description}</p>
            <Link
              href="/contact"
            ...
            <a
              ...
              className="mt-2 block font-mono text-sm text-white/35 transition-colors hover:text-white/70"
            >
              sales@heathuw.com
            </a>
          </div>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-between gap-3 border-t border-white/[0.07] pt-8">
          <span className="text-xs text-white/30">{dict.footer.copyright}</span>
          <span className="font-mono text-xs tracking-wider text-white/30">heathuw.com</span>
        </div>
      </div>
    </footer>
  );
